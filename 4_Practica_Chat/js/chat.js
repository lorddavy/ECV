...
function printData(data){
	...
	if(localMsg=="")
	{
		...
		var e = document.createElement("p");
		e.className = "message";
		e.innerHTML = "<span class='tagNombre'>" + localName + " (Está en Coordenadas: " + localPos + ")" + "</span>: " + localMsg;
        e.addEventListener("click", function() {
            setView([localPos[0], localPos[1], localPos[2]]);
        })
		root.appendChild(e);
		return e;
	}
...
function init(){
    ...
    getView(); //Posición inicial de camara
}
