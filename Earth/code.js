...
function createEarthMaterial() {
    ...
    var loader = new THREE.ImageLoader();
    loader.load('earth.normalmap.jpg', function(image){
    ...
    var loader = new THREE.ImageLoader();
    loader.load('earth.specularmap.jpg', function(image){
...
function createCloudsMaterial() {
    ...
    var loader = new THREE.ImageLoader();
    loader.load('clouds.png', function(image){
...
function createEnviroment(){
  ...
  envMaterial.map = THREE.ImageUtils.loadTexture('stars.png')
